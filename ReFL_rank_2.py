"""
@File       :   ReFL_rank.py
@Description:   对比学习，先对数据进行打分，选出样本.
* Based on diffusers code base
* https://github.com/huggingface/diffusers/blob/main/examples/text_to_image/train_text_to_image.py
离线扩充样本 3,4,7,10

* 传入 ranked_num.json, num 代表有多少个
...
from dataset import S2C_Dataset_Rank
...
def main():
    ...
    with accelerator.main_process_first():
        train_dataset = S2C_Dataset_Rank(
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                # reshape input_ids [bsz,1,77]->[bsz,77]
                ...
                batch["rm_attention_mask"] =  batch["rm_mask"].view(-1, batch["rm_mask"].shape[-1]) 
