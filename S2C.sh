...
CUDA_VISIBLE_DEVICES=$gpu_ids accelerate launch --multi_gpu --mixed_precision=fp16 --num_processes=2 --main_process_port 29500 ReFL_loss.py \
  ...
  --output_dir="/data/liutao/checkpoints/SD_1-4/S2C_rank" \
  --grad_scale 0.001 \
